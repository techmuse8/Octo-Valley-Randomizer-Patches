...
extern s32 (*connect)(s32 s, const struct sockaddr *addr, s32 addrlen);
...
extern s32 (*select)(int nfds,
       fd_set *readfds,
       fd_set *writefds,
       fd_set *exceptfds,
       struct timeval *timeout);
extern s32 (*socketlasterr)(void);
extern s32 (*getpeername)(s32 sockfd, struct sockaddr *addr, s32 *addrlen);
extern s32 (*getsockname)(s32 sockfd, struct sockaddr *addr, s32 *addrlen);
extern s32 (*getsockopt)(s32 s, s32 level, s32 optname, void *optval, s32 *optlen);
extern s32 (*getaddrinfo)(const char *node,
                     const char *service,
                     const struct addrinfo *hints,
                     struct addrinfo **res);
extern void (*freeaddrinfo)(struct addrinfo *res);
extern s32 (*getnameinfo)(const struct sockaddr *sa, s32 salen,
