...
EXPORT_DECL(OSTime, OSCalendarTimeToTicks, OSCalendarTime * calendarTime);
...
EXPORT_DECL(int *, __gh_errno_ptr_dyn, void);
...
void InitOSFunctionPointers(void) {
   ...
   // OS_FIND_EXPORT(coreinit_handle, __gh_errno_ptr_dyn);
    OSDynLoad_FindExport(coreinit_handle, 0, "__gh_errno_ptr", &__gh_errno_ptr_dyn);
    ...
    OS_FIND_EXPORT(coreinit_handle, OSCalendarTimeToTicks);
