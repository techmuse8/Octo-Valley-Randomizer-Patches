...
EXPORT_DECL(s32, connect, s32 s, const struct sockaddr *addr, s32 addrlen);
...
EXPORT_DECL(s32, select, int nfds,
       fd_set *readfds,
       fd_set *writefds,
       fd_set *exceptfds,
...
EXPORT_DECL(s32, getpeername, s32 sockfd, struct sockaddr *addr, s32 *addrlen);
EXPORT_DECL(s32, getsockname, s32 sockfd, struct sockaddr *addr, s32 *addrlen);
EXPORT_DECL(s32, getsockopt, s32 s, s32 level, s32 optname, void *optval, s32 *optlen);
EXPORT_DECL(s32, getaddrinfo, const char *node,
                     const char *service,
                     const struct addrinfo *hints,
                     struct addrinfo **res);
EXPORT_DECL(void, freeaddrinfo, struct addrinfo *res);
EXPORT_DECL(s32, getnameinfo, const struct sockaddr *sa, s32 salen,
                          char *host, s32 hostlen,
                          char *serv, s32 servlen, s32 flags);
...
void InitSocketFunctionPointers(void) {
    ...
    OS_FIND_EXPORT(nsysnet_handle, select);
    ...
    OS_FIND_EXPORT(nsysnet_handle, getpeername);
    OS_FIND_EXPORT(nsysnet_handle, getsockname);
    OS_FIND_EXPORT(nsysnet_handle, getsockopt);
    OS_FIND_EXPORT(nsysnet_handle, getaddrinfo);
    OS_FIND_EXPORT(nsysnet_handle, freeaddrinfo);
    OS_FIND_EXPORT(nsysnet_handle, getnameinfo);
